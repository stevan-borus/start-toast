...
- `@tanstack/react-start-toast` — client-safe React (`FlashToastEffect`, `ToastProvider`, types)
- `@tanstack/react-start-toast/server` — server-only helpers (`setFlashToast`, `redirectWith*`, `replaceWith*`, …)
